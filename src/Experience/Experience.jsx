...
export const Experience = () => {
  ...
  return (
    <div className="container-webgl fixed inset-0">
      ...
      <InfoModal />
      {/* loader con html y estilos de tailwind */}
      <div
        className="fixed top-0 left-0 z-50 flex h-full w-full bg-[#150A35]"
        style={{ zIndex: 99999999 }}
        ref={loaderRef}
      >
        {/* <Loader /> */}
        <div className="flex, absolute flex h-full w-full flex-col items-center justify-center text-purple-100">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="svg-loader w-[50vw] max-w-60"
            viewBox="0 0 640 512"
          >
            <path
              fill="currentColor"
          ...
          <p className="text-md text-loader mt-5 animate-pulse lg:text-xl">
            Cargando
          </p>
        </div>
      </div>
